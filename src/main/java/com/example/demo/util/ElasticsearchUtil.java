...
public class ElasticsearchUtil {
    ...
    public static Query buildTermQuery(String field, String value, float boost) {
        TermQuery termQuery = TermQuery.of(builder -> builder.field(field)
                .value(value)
                .boost(boost)
    ...
    public static Query buildGeoDistanceQuery(String field, String distance, Double latitude, Double longitude) {
        LatLonGeoLocation latLonLocation = LatLonGeoLocation.of(builder -> builder.lat(latitude).lon(longitude));
        GeoLocation geoLocation = GeoLocation.of(builder -> builder.latlon(latLonLocation));
    ...
    public static Query buildMultiMatchQuery(List<String> fields, String searchTerm) {
        MultiMatchQuery multiMatchQuery = MultiMatchQuery.of(builder -> builder.query(searchTerm)
                .fields(fields)
